...
const translations = {
    es: {
        ...
        playerStyle: "Diseño:",
        playerStyleCustom: "Reproductor (Sleep Token)",
        playerStyleHidden: "Solo Letra (Sin reproductor)",
        // Nueva opción Alineación Reproductor
        playerAlign: "Alineación Reproductor:",
        alignLeft: "Izquierda",
        alignCenter: "Centro",
        alignRight: "Derecha",
    ...
    en: {
        ...
        playerStyle: "Design:",
        playerStyleCustom: "Player (Sleep Token)",
        playerStyleHidden: "Lyrics Only (No player)",

        playerAlign: "Player alignment:",
        alignLeft: "Left",
        alignCenter: "Center",
        alignRight: "Right",
    ...
    pt: {
        ...
        playerStyle: "Design:",
        playerStyleCustom: "Player (Sleep Token)",
        playerStyleHidden: "Apenas Letras (Sem player)",

        playerAlign: "Alinhamento do Player:",
        alignLeft: "Esquerda",
        alignCenter: "Centro",
        alignRight: "Direita",
